...
## for build a API Public
## I dont use a database anything (just Spring Boot and gladle for kotlin). So this API Public Static (with JSON)
...
# still in the development stage. sorry🙏





## Thank you to the Metal Cardbot fandom wiki for providing information about Metal Cardbot as a resource🙏.
## And thank you also to those of you who have used my API🙏.
